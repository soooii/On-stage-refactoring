...
public class SummaryService {
    ...
    public void saveSummary(Long userId) {
        ...
        String prompt = "다음 문장을 부정적이거나 논란이 될 수 있는 주제는 배제하고, 아티스트를 소개할 수 있는 측면에 초점을 맞춰서 두 개의 간결한 뉴스 기사로 요약해줘. " + allArticles;
        //String gptResponse = openAiService.summarizeText(prompt);
